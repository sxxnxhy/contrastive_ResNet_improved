...
def visualize_tsne(embeddings, class_labels, modalities, class_names, save_path='tsne_visualization.png'):
    ...
    ax.set_title('Embedding Space: Colored by Class (○=Raman, □=GC)', fontsize=14, fontweight='bold')
    ...
    ax.set_xlabel('t-SNE 1', fontsize=12)
    ax.set_ylabel('t-SNE 2', fontsize=12)
    ax.set_title('Embedding Space: Colored by Modality', fontsize=14, fontweight='bold')
...
def main():
    ...
    visualize_tsne(embeddings, class_labels, modalities, class_names, save_path)
